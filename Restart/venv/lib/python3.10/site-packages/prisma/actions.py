...
class UserActions(Generic[_PrismaModelT]):
    ...
    async def find_many(
        ...
        # find the first 5 User records ordered by the filter field
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group User records by filter values
...
class ActivityTypeActions(Generic[_PrismaModelT]):
    ...
    async def find_unique_or_raise(
        ...
        """Find a unique ActivityType record. Raises `RecordNotFoundError` if no record is found.
        ...
        -------
        ```py
        activitytype = await ActivityType.prisma().find_unique_or_raise(
            where={
                'id': 19769016624,
            },
        )
    ...
    async def find_first_or_raise(
        ...
        """Find a single ActivityType record. Raises `RecordNotFoundError` if no record was found.
        ...
        -------
        ```py
        # find the second ActivityType record ordered by the name field
        activitytype = await ActivityType.prisma().find_first_or_raise(
            skip=1,
            order={
                'name': 'desc',
            },
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group ActivityType records by pillar values
        # and count how many records are in each group
...
class SwitchesActions(Generic[_PrismaModelT]):
    ...
    async def find_unique_or_raise(
        ...
        """Find a unique Switches record. Raises `RecordNotFoundError` if no record is found.
        ...
        -------
        ```py
        switches = await Switches.prisma().find_unique_or_raise(
            where={
                'id': 15636044472,
            },
        )
    ...
    async def find_first_or_raise(
        ...
        """Find a single Switches record. Raises `RecordNotFoundError` if no record was found.
        ...
        -------
        ```py
        # find the second Switches record ordered by the name field
        switches = await Switches.prisma().find_first_or_raise(
            skip=1,
            order={
                'name': 'desc',
            },
    ...
    async def update_many(
        ...
        total = await Switches.prisma().update_many(
            data={
                'switch': datetime.datetime.utcnow()
            },
            where={}
        )
        ```
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Switches records by switch values
        # and count how many records are in each group
...
class VCTypeActions(Generic[_PrismaModelT]):
    ...
    async def find_unique_or_raise(
        ...
        """Find a unique VCType record. Raises `RecordNotFoundError` if no record is found.
        ...
        -------
        ```py
        vctype = await VCType.prisma().find_unique_or_raise(
            where={
                'id': 5159941248,
            },
        )
    ...
    async def find_first_or_raise(
        ...
        """Find a single VCType record. Raises `RecordNotFoundError` if no record was found.
        ...
        -------
        ```py
        # find the second VCType record ordered by the id field
        vctype = await VCType.prisma().find_first_or_raise(
            skip=1,
            order={
                'id': 'desc',
            },
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group VCType records by id values
        # and count how many records are in each group
...
class SessionActions(Generic[_PrismaModelT]):
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second Session record ordered by the nick field
...
class ActivityLogActions(Generic[_PrismaModelT]):
    ...
    async def create(
        ...
        activitylog = await ActivityLog.prisma().create(
            data={
                ...
                'activity': 'cafdaehjid',
                'activityType': 'gifdddbia',
                'userId': 1529690940,
                'sessionId': 11387061048,
            },
        )
        ```
        """
            ...
            data=[
                {
                    ...
                    'userId': 3062433036,
                    'sessionId': 14682886344,
                },
                {
                    # data to create a ActivityLog record
                    'activity': 'febcgjbfj',
                    'activityType': 'bageiegghg',
                    'userId': 6100589532,
                    'sessionId': 12291188568,
                },
            ],
            skip_duplicates=True,
        )
    ...
    async def find_unique_or_raise(
        ...
        """Find a unique ActivityLog record. Raises `RecordNotFoundError` if no record is found.
        ...
        -------
        ```py
        activitylog = await ActivityLog.prisma().find_unique_or_raise(
            where={
                'id': 11002761132,
            },
        )
    ...
    async def find_first_or_raise(
        ...
        """Find a single ActivityLog record. Raises `RecordNotFoundError` if no record was found.
        ...
        -------
        ```py
        # find the second ActivityLog record ordered by the joinedAt field
        activitylog = await ActivityLog.prisma().find_first_or_raise(
            skip=1,
            order={
                'joinedAt': 'desc',
            },
    ...
    async def update_many(
        ...
        total = await ActivityLog.prisma().update_many(
            data={
                'leftAt': datetime.datetime.utcnow()
            },
            where={}
        )
        ```
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group ActivityLog records by status values
        # and count how many records are in each group
...
class UserLevelActions(Generic[_PrismaModelT]):
    ...
    async def find_unique_or_raise(
        ...
        """Find a unique UserLevel record. Raises `RecordNotFoundError` if no record is found.
        ...
        -------
        ```py
        userlevel = await UserLevel.prisma().find_unique_or_raise(
            where={
                'id': 19931185416,
            },
        )
    ...
    async def find_first_or_raise(
        ...
        """Find a single UserLevel record. Raises `RecordNotFoundError` if no record was found.
        ...
        -------
        ```py
        # find the second UserLevel record ordered by the userId field
        userlevel = await UserLevel.prisma().find_first_or_raise(
            skip=1,
            order={
                'userId': 'desc',
            },
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group UserLevel records by xp values
        # and count how many records are in each group
