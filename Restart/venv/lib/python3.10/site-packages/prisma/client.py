...
SCHEMA_PATH = Path('/home/simon/code/discord/spqr--bot/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = BinaryPaths.parse_obj({'queryEngine': {'debian-openssl-3.0.x': '/home/simon/.cache/prisma-python/binaries/4.11.0/8fde8fef4033376662cad983758335009d522acb/node_modules/prisma/query-engine-debian-openssl-3.0.x'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma:
    ...
    activitytype: 'actions.ActivityTypeActions[models.ActivityType]'
    switches: 'actions.SwitchesActions[models.Switches]'
    vctype: 'actions.VCTypeActions[models.VCType]'
    session: 'actions.SessionActions[models.Session]'
    activitylog: 'actions.ActivityLogActions[models.ActivityLog]'
    userlevel: 'actions.UserLevelActions[models.UserLevel]'
    ...
    def __init__(
        ...
        *,
        ...
        self.activitytype = actions.ActivityTypeActions[models.ActivityType](self, models.ActivityType)
        self.switches = actions.SwitchesActions[models.Switches](self, models.Switches)
        self.vctype = actions.VCTypeActions[models.VCType](self, models.VCType)
        self.session = actions.SessionActions[models.Session](self, models.Session)
        self.activitylog = actions.ActivityLogActions[models.ActivityLog](self, models.ActivityLog)
        self.userlevel = actions.UserLevelActions[models.UserLevel](self, models.UserLevel)
    ...
    def _default_datasource(self) -> DatasourceOverride:
        return {
            'name': 'db',
            'url': OptionalValueFromEnvVar(**{'value': 'mysql://simon:spqr-server@localhost/discordjs', 'fromEnvVar': None}).resolve(),
        }
...
class Batch:
    ...
    activitytype: 'ActivityTypeBatchActions'
    switches: 'SwitchesBatchActions'
    vctype: 'VCTypeBatchActions'
    session: 'SessionBatchActions'
    activitylog: 'ActivityLogBatchActions'
    userlevel: 'UserLevelBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.activitytype = ActivityTypeBatchActions(self)
        self.switches = SwitchesBatchActions(self)
        self.vctype = VCTypeBatchActions(self)
        self.session = SessionBatchActions(self)
        self.activitylog = ActivityLogBatchActions(self)
        self.userlevel = UserLevelBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class ActivityTypeBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
