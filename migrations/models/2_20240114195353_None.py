...
CREATE TABLE IF NOT EXISTS `rolepillar` (
    ...
    `pillar_id` INT NOT NULL,
    `role_id` INT NOT NULL,
    CONSTRAINT `fk_rolepill_pillar_0a460cb3` FOREIGN KEY (`pillar_id`) REFERENCES `pillar` (`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_rolepill_role_6cc9ed86` FOREIGN KEY (`role_id`) REFERENCES `role` (`id`) ON DELETE CASCADE
) CHARACTER SET utf8mb4;
...
CREATE TABLE IF NOT EXISTS `channel` (
    `id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
    `name` VARCHAR(100) NOT NULL,
    `channel_type` VARCHAR(50) NOT NULL  COMMENT 'LEADERBOARD: Leaderboard\nTASKS: Tasks\nVOICE: Voice\nTEXT: Text\nCATEGORY: Category',
...
CREATE TABLE IF NOT EXISTS `user` (
    ...
    `timezone` INT NOT NULL  DEFAULT 2,
