...
class ImageCreator:
    def __init__(self):
        self.name = "image"
    #TODO: implement the strategy pattern here
    async def create_image(self, data, timeframe):
        image_filename = self.create_leaderboard_image(data, timeframe)
        return await self.send_temp_message(image_filename)

    def create_leaderboard_image(self, data, timeframe):
        ...
        if timeframe == 'today':
            ...
            self.draw_timeline(SEGMENTS_PER_HOUR, TIMELINE_HEIGHT, avatar_x_position, draw, pixel_per_segment,
        ...
        for i, row_data in enumerate(data):
            ...
            # calculate the spent time per user
            ...
            image.paste(avatar_image, (24, avatar_y_position), mask)
            # Paste the avatar image onto the leaderboard image
    ...
    def draw_timeline(self, SEGMENTS_PER_HOUR, TIMELINE_HEIGHT, avatar_x_position, draw, pixel_per_segment,
                      segments_in_24_hours, timeline_font):
