// THIS IS AN IDEA OF A FUNCTION FOR FUTURE USE, THIS FUNCTION WILL MAKE IT POSSIBLE FOR PEOPLE TO
// PLAN ACTIVITIES AND DO THEM TOGETHER
...
const activities = ["meditate", "workout", "read", "study", "journal"];
...
function embedCreator() {
    ...
    const embed = new EmbedBuilder()
        ...
        .setImage(
            "https://c4.wallpaperflare.com/wallpaper/667/4/23/statue-sculpture-black-background-philosophy-black-background-hd-wallpaper-preview.jpg"
        )
        .addFields(fields);
    // add fields to embed
